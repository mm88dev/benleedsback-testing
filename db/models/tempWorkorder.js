...
const tempWorkorder = module.exports = mongoose.model("tempworkorder", tempWorkorderSchema);
...
module.exports.saveTempWorkorder = function (autosavedWorkorder, res, callback) {
    ...
    .catch(err => {
        ...
        console.log("An error has occurred while trying to autosave a workorder " + err);
    });
};

// user updates existing temporary workorder
module.exports.updateTempWorkorder = function (autosavedWorkorder, res, callback) {

    tempWorkorder.findByIdAndUpdate(autosavedWorkorder._id, {
        $set: {
    ...
    .catch(err => {
        ...
        console.log("An error has occurred while trying tupdate an autosaved workorder " + err);
    });
};
...
module.exports.getTempWorkorder = function (autosavedWorkorder, callback) {
    ...
    .catch(err => {
        ...
        console.log("An error occured while recovering a temporary workorder " + err);
    });
};
...
module.exports.deleteTempWorkorder = function(workorderData, callback) {
    ...
    .catch(err => {
        ...
        console.log("An error occurred while removing a temporary workorder " + err);
    });
};
...
module.exports.getUserTempWorkordersLogin = function(userData, res, callback) {
    ...
    .catch(err => {
        ...
        console.log("An error has occurred while recovering user's temporary workorders " + err);
    });
}
...
module.exports.getUserTempWorkorders = function(userId, res, callback) {
    ...
    .catch(err => {
        ...
        console.log("An error has occured while recovering user's temporary workorders " + err);
    });
};